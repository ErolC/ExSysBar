...
class LifeCycleNavBar(
    owner: LifecycleOwner,
    private val bar: NavigationBar
) : NavigationBar by bar {
    internal val exeBar = (if (bar is LifeCycleNavBar) bar.bar else bar) as NavigationBarImpl
